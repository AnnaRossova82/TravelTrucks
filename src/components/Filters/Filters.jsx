        ...
        <div className={styles.filters}>
            ...
            <div className={styles.filterCategory}>
                ...
                <div className={styles.cardsList}>
                    <label className={`${styles.filterItem} ${filters.equipment.AC ? styles.selected : ''}`}>
                        <input
                            type="checkbox"
                            name="AC"
                    ...
                    <label className={`${styles.filterItem} ${filters.equipment.Automatic ? styles.selected : ''}`}>
                        <input
                            type="checkbox"
                            name="Automatic"
                    ...
                    <label className={`${styles.filterItem} ${filters.equipment.Kitchen ? styles.selected : ''}`}>
                        <input
                            type="checkbox"
                            name="Kitchen"
                    ...
                    <label className={`${styles.filterItem} ${filters.equipment.TV ? styles.selected : ''}`}>
                        <input
                            type="checkbox"
                            name="TV"
                    ...
                    <label className={`${styles.filterItem} ${filters.equipment.Bathroom ? styles.selected : ''}`}>
                        <input
                            type="checkbox"
                            name="Bathroom"
            ...
            <div className={styles.filterCategory}>
                ...
                <div className={styles.filterOptions}>
                    <label className={`${styles.filterItem} ${filters.activeFilters.Van ? (filters.vehicleType === 'Van' ? styles.selected : '') : styles.disabled}`}>
                        <input
                            type="radio"
                            name="vehicleType"
                            value="Van"
                    ...
                    <label className={`${styles.filterItem} ${filters.activeFilters['Fully Integrated'] ? (filters.vehicleType === 'Fully Integrated' ? styles.selected : '') : styles.disabled}`}>
                        <input
                            type="radio"
                            name="vehicleType"
                    ...
                    <label className={`${styles.filterItem} ${filters.activeFilters.Alcove ? (filters.vehicleType === 'Alcove' ? styles.selected : '') : styles.disabled}`}>
                        <input
                            type="radio"
                            name="vehicleType"
                            value="Alcove"
